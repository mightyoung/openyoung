...
This project is indexed by GitNexus as **openyoung** (92465 symbols, 208640 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/openyoung/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/openyoung/context` | Codebase overview, check index freshness |
| `gitnexus://repo/openyoung/clusters` | All functional areas |
| `gitnexus://repo/openyoung/processes` | All execution flows |
| `gitnexus://repo/openyoung/process/{name}` | Step-by-step execution trace |
